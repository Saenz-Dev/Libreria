...
public class VentanaPrincipal extends JFrame {
	...
	try {
	    ...
	    JOptionPane.showMessageDialog(menuPrincipal.getPanelModificarUsuario(), e.getMessage(), "Error",
		    JOptionPane.ERROR_MESSAGE);
	}
    }
	...
	try {
	    ...
	    menuPrincipal.getPanelPerfil()
		    .setLabelCorreo("Correo: " + gestionTienda.getUserLogin().getCuenta().getCorreo());
	    menuPrincipal.getPanelPerfil()
	...
	try {
	    ...
	    JOptionPane.showMessageDialog(menuPrincipal.getPanelRegistrarUsuario(), "Usuario Registrado Exitosamente",
	...
	try {
	    ...
	    JOptionPane.showMessageDialog(menuPrincipal.getPanelModificarUsuario(), "Usuario Modificado Exitosamente",
	...
	try {
	    ...
	    JOptionPane.showMessageDialog(menuPrincipal.getPanelModificarLibro(), "Libro Modificado Exitosamente",
		    "Informacion", JOptionPane.INFORMATION_MESSAGE);
	    String[] titulosLibros = gestionTienda.obtenerTitulosLibros();
	    menuPrincipal.getPanelModificarLibro().listarLibros(titulosLibros);
	} catch (SQLException e) {
	...
	try {
	    ...
	    JOptionPane.showMessageDialog(this, "El libro ha sido registrado", "Libro Registrado",
		    JOptionPane.INFORMATION_MESSAGE);
	    menuPrincipal.getPanelRegistrarLibro().limpiarTxtFieldsLibro();
	...
	try {
	    gestionTienda.eliminarProductoCarrito(isbnProducto);
	    menuPrincipal.getPanelConfirmCompra().llenarTabla(gestionTienda.valorCompra(),
		    gestionTienda.listaCarrito());
	...
	try {
		...
		JOptionPane.showMessageDialog(menuPrincipal.getPanelCarrito(),
			"No hay productos en el carrito para comprar \nSeleccionalos en la sección catálogo.",
			"Información", JOptionPane.INFORMATION_MESSAGE);
		return;
	    }
	    if (debeIniciarSesion())
		return;// Salimos del metodo sin activar el panel si el usuario es genérico
	    menuPrincipal.getPanelConfirmCompra().llenarTabla(gestionTienda.valorCompra(),
		    gestionTienda.listaCarrito());
	...
	if (gestionTienda
		.isGenericoLogin() /* || tienda.getUserLogin().getCuenta().getCorreo().equals("user_default") */) {
	    int respuesta = JOptionPane.showConfirmDialog(this, "No ha iniciado sesión, ¿Desea Iniciar Sesión?",
		    "Inicie Sesión", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
	...
	try {
	    ...
	    JOptionPane.showMessageDialog(menuPrincipal.getPanelCalificar(), "Comentario registrado exitosamente",
		    "Informacion", JOptionPane.INFORMATION_MESSAGE);
