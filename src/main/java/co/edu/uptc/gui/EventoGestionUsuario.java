...
public class EventoGestionUsuario implements ItemListener {
     ...
     */
    public EventoGestionUsuario(VentanaPrincipal ventanaPrincipal) {
    ...
    public void itemStateChanged(ItemEvent itemEvent) {
        if (itemEvent.getStateChange() == ItemEvent.SELECTED) {
            ventanaPrincipal.cambiarInfoUsuario();
        }
    }
}
