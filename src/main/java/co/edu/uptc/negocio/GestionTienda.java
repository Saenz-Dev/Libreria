...
public class GestionTienda {
    ...
    private ProductoCompra aggInfoProductoCompra(CalculadoraIVA calculadoraIVA, LibroCarrito libroCarrito, LibroCarrito libroCarritoUser) throws SQLException {
